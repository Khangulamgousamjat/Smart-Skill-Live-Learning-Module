    ...
    <DashboardLayout>
      <div>
        <div className="mb-6">
          ...
          <p className="text-[var(--color-text-muted)] text-sm mt-1">Manage all user accounts, roles, and statuses</p>
        </div>
        <div className="bg-[var(--color-surface)] border border-[var(--color-border)] rounded-xl p-8 text-center">
          <Construction size={40} className="mx-auto mb-3 text-[var(--color-accent)]" />
          <p className="font-sora font-semibold text-[var(--color-text-primary)]">User Directory & Controls</p>
