...
export default function ExpertMessages() {
  return (
    <DashboardLayout>
      <div>
        <div className="mb-6">
          <h1 className="text-2xl font-bold font-sora text-[var(--color-text-primary)]">Expert Messages</h1>
        ...
        <div className="bg-[var(--color-surface)] border border-[var(--color-border)] rounded-xl p-8 text-center">
          ...
          <p className="font-sora font-semibold text-[var(--color-text-primary)]">Expert Communication Inbox</p>
