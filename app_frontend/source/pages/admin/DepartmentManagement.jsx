    ...
    <DashboardLayout>
      <div>
        <div className="mb-6">
          ...
          <p className="text-[var(--color-text-muted)] text-sm mt-1">Add, update, and manage organizational departments</p>
        </div>
        <div className="bg-[var(--color-surface)] border border-[var(--color-border)] rounded-xl p-8 text-center">
          <Construction size={40} className="mx-auto mb-3 text-[var(--color-accent)]" />
          <p className="font-sora font-semibold text-[var(--color-text-primary)]">Department Control Center</p>
